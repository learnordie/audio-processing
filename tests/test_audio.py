...
filename2 = os.path.join(SAMPLES_DIR, "mono_22050_16bits.wav")
mono_22050_16bits = audio.Audio(filename2)

filename3 = os.path.join(SAMPLES_DIR, "mono_44100_32bits.wav")
...
def test_data_type_1():
    """ Test the data type of the file "mono_44100_32bits.wav",
